          ...
          <div className="container">
            ...
            <form onSubmit={this.updateInformation}>
              ...
              <FormControl component="fieldset">
                <FormLabel component="legend">Close or Open Foodbox</FormLabel>
                <RadioGroup row aria-label="status" name="status" value={this.state.status} onChange={event => this.handleChange({status: event.target.value})}>
                  <FormControlLabel value="open" control={<Radio color="gray"/>} label="Open" />
                  <FormControlLabel value="close" control={<Radio color="gray"/>} label="Close" />
                </RadioGroup>
              </FormControl>
              <Button
                type="submit"
